  ...
  getContent: function () {
    return [
      '<div id="mainHelp">',
        ...
        '<h2>IRC Commands</h2>',
        '<p>',
          'Diomedes supports most IRC commands such as /join /mode /topic etc as ',
          ' well as common shortcuts for those commands including /j for join etc.',
        ...
        '<dl>',
          ...
          '<dt>/pass</dt>',
          '<dd>',
           'Supply a connection with a username and password in the format of &lt;username&gt;:&lt;password&gt;',
          '</dd>',
          '<dt>/nick</dt>',
          '<dd>',
          ...
          '<dt>/win  or /w</dt>',
          '<dd>',
            'Change to a different window. Ex: /win 2 (changes to window #2)',
          '</dd>',
          '<dt>/exit </dt>',
          '<dd>',
