    ...
    return [
      '<div class="preferences">',
        ...
        '<form id="preferenceForm">',
          ...
          '</div>',
          '<div class="formItem">',
            '<label for="pingServer">Ping server:</label> <input type="checkbox" id="pingServer" />',
            '<p class="formItemNote">Pinging the server helps improve connection stability; disable if you use a BNC.</p>',
          '</div>',
          '<div class="formItem">',
